def pattern(name):
 ...
 for i in range(len(name)):
        if name[i] =="A":
            ...
            for row in range(7):
                for col in range(6):
                    if ((col==0 or col==5) and row!=0) or (row==0  and (col!=0 and col!=5)):
                        print_A[row][col] = "*"
            ...
            for row in range(7):
                for col in range(6):
                    if col==0 or ((rows==3 or rows==0 or rows==6)and col!=5) or (col==5 and (row!=3 and row!=0)):
                        print_B[row][col] = "*"
            ...
            for row in range(7):
                for col in range(6):
                    if col==0 or (col==5 and (row!=0 and row!=6)) or ((row==0 or row==6)):
                        print_D[row][col] = "*"
            ...
            for row in range(7):
                for col in range(6):
                    if col == 0 or (col ==4 and (row!=1 and row!=2)) or  ((row == 0 and (col>0 and col<4)) or (row==3 or col==5)):
                      print_G[row][col]= "*"
           ...
           list2.append(print_M)
            ...
            print_O = [[" "for i in range(7)]for j in range(6)]
            for row in range(7):
                for j in range(6):
            ...
            print_S=[[" " for i in range(7)]for j in range(6)]
            for row in range(7):
                for col in range(6):
            ...
            print_T = [[" " for i in range(7)]for j in range(6)]
            for row in range(7):
                for col in range(6):
            ...
            print_U = [[" "for i in range(7)]for j in range(6)]
            for row in range(7):
                for col in range(6):
                    if((col == 0 or col == 5) and row!=6):
                      print_U[row][col]= "*"
         ...
         print_Y = [[" "for i in range(7)]for j in range(6)]
         for row in range(7):
            for col in range(6):
                if (col == 2 and row>1) or (row == col and ccol<2) or (row==0 and col==4) or (row ==1 and col ==3):
                    print_Y[row][col] = "*"
